// getToast("danger", "Error!", "Error.");  
// getToast("warning", "Warning!", "Warning.");  
// getToast("success", "Success!", "Success."); 

function getToast(mode, title, msg){
    $.gritter.add({
        title: title,
        text: msg,
        ...
        sticky: false, 
        time: '',
        class_name: 'gritter-'+mode+'' 
    });  
    return false; 
}

function getToast_admin(mode, title, msg){
	$.gritter.add({
        title: title,
        text: msg,
        image: '../assets/images/'+mode+'.png',
