...
require 'C:\xampp\htdocs\StVincent_v1.3\includes\vendor\phpmailer\src\Exception.php';
require 'C:\xampp\htdocs\StVincent_v1.3\includes\vendor\phpmailer\src\PHPMailer.php';
require 'C:\xampp\htdocs\StVincent_v1.3\includes\vendor\phpmailer\src\SMTP.php';
require 'config.php';
...
if (isset($_POST['data']) && $_POST['data'] == "user_signup") {
    ...
    $token = generateToken();
    $url = "http://localhost:8080/GitHub/StVincent/registration/?token=" . $token;
